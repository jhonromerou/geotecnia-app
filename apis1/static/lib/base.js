...
$M.liAdd('crd',[
	...
	{k:'o.reports',t:'Reportes',kau:'public',mdlActive_:'sysRep', ico:'fa fa_doc',ini:{f:null, g:$0s.Report.get }}
]);
...
$JsV.addKeyValue = (P) => {
	$JsV._i({kMdl: P.kMdl, kObj: P.key, mdl: 'a1', liTxtG: P.title, liTxtF: P.title_form});
}
