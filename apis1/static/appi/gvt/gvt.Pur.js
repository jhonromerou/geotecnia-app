...
Gvt.Rce={
	...
	form:function(){
		...
		$Api.get({f:Api.Gvt.pr+'rce/form',loadVerif:!Pa.docEntry,inputs:'docEntry='+Pa.docEntry,loade:cont,func:function(Jr){
			...
			tbH:[
				...
				{divLine:1,wxn:'wrapx8',L:'Valor pagado',I:{lTag:'$',name:'bal','class':jsF+' _bal'}},
		...
		function reLoa(tv){
			...
			if(tv=='E'){
				...
				var tBody=$1.t('tbody',{},tb);
				if(crd.AJs && crd.AJs.cardId){ Gvt.Rce.getInvs(crd.AJs,tBody); }
	...
	getInvs:function(Px,tBody){ //tabla con facturas a pagar
		$Api.get({f:Api.Gvt.pr+'rce/invs',inputs:'cardId='+Px.cardId,loade:tBody,func:function(Jr){
			if(Jr.errNo){ $Api.resp($1.t('div',0,$1.t('td',{colspan:7},$1.t('tr',0,tBody))),Jr); }
				...
				$Api.foreach(Jr.L,function(L){
					var tr=$1.t('tr',{'class':$Api.JS.clsL+' '+tbCal._row},tBody);
					var tinp=$1.t('input',{type:'checkbox','class':jsF,name:'payTo'},$1.t('td',0,tr));
					tinp.bal=L.creBalDue*1;
					tinp.onclick=function(){
						var val=$1.q('.val',this.parentNode.parentNode);
						if(this.checked){ val.value=this.bal; }
						else{ val.value=0; }
					...
					var td=$1.t('td',0,tr);
					$1.lTag({tag:'$','class':jsF+' '+tbCal._cell+' val',ncol:1,name:'debBal',min:0,max:L.creBalDue,placeholder:L.creBalDue*1,AJs:{acId:L.acId},onkeychange:function(){
						tbCal.sumCells(tBody);
					}},td);
				});
				var tr=$1.t('tr',0,tBody);
...
$M.liAdd('gvtPur',[
	{_lineText:'Compras'},
	{k:'gvtPor',t:'Orden de Compra', kau:'gvtPor',ini:{btnGo:'gvtPor.form',f:'gvtPor',gyp:Gvt.Por.get}},
	{k:'gvtPor.form',t:'Orden de Compra', kau:'gvtPor',ini:{g:Gvt.Por.form}},
	{k:'gvtPor.view',noTitle:true, kau:'gvtPor',ini:{g:Gvt.Por.view}},
	...
	{k:'gvtPin',t:'Factura de Compra', kau:'gvtPin',ini:{btnGo:'gvtPin.form',f:'gvtPin',gyp:Gvt.Pin.get}},
	{k:'gvtPin.form',t:'Factura de Compra', kau:'gvtPin',ini:{g:Gvt.Pin.form}},
	{k:'gvtPin.view',noTitle:true, kau:'gvtPin',ini:{g:Gvt.Pin.view}},
	...
	{k:'gvtPnc',t:'Nota Crédito Proveedor', kau:'gvtPnd',ini:{btnGo:'gvtPnc.form',f:'gvtPnc',gyp:Gvt.Pnc.get}},
	{k:'gvtPnc.form',t:'Nota Crédito Proveedor', kau:'gvtPnc',ini:{g:Gvt.Pnc.form}},
	{k:'gvtPnc.view',noTitle:true, kau:'gvtPnc',ini:{g:Gvt.Pnc.view}},
	
	{k:'gvtPnd',t:'Nota Débito Proveedor', kau:'gvtPnd',func:function(){
		$M.Ht.ini({btnGo:'gvtPnd.form',f:'gvtPnd',gyp:Gvt.Pnd.get}); }},
	{k:'gvtPnd.form',t:'Nota Débito Proveedor', kau:'gvtPnd',ini:{g:Gvt.Pnd.form}},
	{k:'gvtPnd.view',t:'Nota débito proveedor',noTitle:true, kau:'gvtPnd',ini:{g:Gvt.Pnd.view}},
	//Finanzas
	
	{k:'gvtRce',t:'Pagos Efectuados',kau:'gvtRce',mdlActive:'gvtSell',func:function(){
		$M.Ht.ini({btnGo:'gvtRce.form',f:'gvtRce',gyp:function(){ Gvt.Rce.get(); }});
	}},
	{k:'gvtRce.form',t:'Pago Efectuado',kau:'gvtRce',mdlActive:'gvtSell',ini:{g:Gvt.Rce.form }},
	{k:'gvtRce.view',noTitle:'Y',t:'Pago Efectuados (Doc)', kau:'gvtRce',mdlActive:'gvtSell',ini:{g:function(){ Gvt.Rce.view(); }}},
	{k:'gvtRce.invs',t:'Pago Efectuado',kau:'gvtRce',mdlActive:'gvtSell',ini:{g:Gvt.Rce.invs }},
