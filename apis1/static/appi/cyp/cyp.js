...
_Fi['cypCrd']=function(wrap){
  ...
  {L:'Ruta',wxn:'wrapx8',I:{lTag:'select',name:'C.logRoute',opts:$Tb.cypRoute}},
  {L:'Cobrador',wxn:'wrapx8',I:{lTag:'select',name:'C.slpId',opts:$Tb.oslp}},
	],wrap);
};
...
_Fi['cypRcv']=function(wrap){
	$Doc.filter({func:JCyp.Rcv.get,docNum:'Y'},[
  {k:'d1'},{k:'d2'},{k:'docStatus'},{k:'card'},{k:'ordBy'},
  {divLine:1,L:'Cobrador',wxn:'wrapx8',I:{lTag:'select',name:'A.slpId',opts:$Tb.oslp}},
  {L:'Ruta',wxn:'wrapx8',I:{lTag:'select',name:'A.logRoute',opts:$Tb.cypRoute}},
  {L:'Sede',wxn:'wrapx8',I:{lTag:'select',name:'A.sucSede',opts:$Tb.cypSede}},
  {L:'Valor >=',wxn:'wrapx8',I:{lTag:'$',name:'A.docTotal(E_mayIgual)'}},
  {L:'Valor <=',wxn:'wrapx8',I:{lTag:'$',name:'A.docTotal(E_menIgual)'}},
...
_Fi['cypRec']=function(wrap){
	$Doc.filter({func:(wrap)=>{ JCyp.Rec.get($M.Ht.cont); }},[
  {k:'d1'},{k:'d2'},{k:'docStatus'},{L:'Socio',k:'card'},{k:'ordBy'},
  {L:'Detalles',wxn:'wrapx4',I:{lTag:'input',name:'A.lineMemo(E_like3)'}},
  {divLine:1,L:'No. Prestamo',wxn:'wrapx8',I:{lTag:'number',name:'A.otr'}},
  {L:'No. Cuota',wxn:'wrapx8',I:{lTag:'number',name:'A.lineNum'}},
  {L:'Categoria',wxn:'wrapx8',I:{lTag:'select',name:'A.docClass',opts:$JsV.cypRecClass}},
  {L:'Valor >=',wxn:'wrapx8',I:{lTag:'$',name:'A.docTotal(E_mayIgual)'}},
  {L:'Valor <=',wxn:'wrapx8',I:{lTag:'$',name:'A.docTotal(E_menIgual)'}},
	],wrap);
};
_Fi['cypEgr']=function(wrap){
	$Doc.filter({func:(wrap)=>{ JCyp.Egr.get($M.Ht.cont); }},[
  {k:'d1'},{k:'d2'},{k:'docStatus'},{L:'Tercero',k:'card'},{k:'ordBy'},
  {L:'Detalles',wxn:'wrapx4',I:{lTag:'input',name:'A.lineMemo(E_like3)'}},
  {divLine:1,L:'Categoria',wxn:'wrapx8',I:{lTag:'select',name:'A.categId',opts:$JsV.cypEgrClass}},
  {L:'Cobrador',wxn:'wrapx8',I:{lTag:'select',name:'A.slpId',opts:$Tb.oslp}},
  {L:'Ruta',wxn:'wrapx8',I:{lTag:'select',name:'A.logRoute',opts:$Tb.cypRoute}},
  {L:'Sede',wxn:'wrapx8',I:{lTag:'select',name:'A.sucSede',opts:$Tb.cypSede}},
  {L:'Valor >=',wxn:'wrapx8',I:{lTag:'$',name:'A.creBal(E_mayIgual)'}},
  {L:'Valor <=',wxn:'wrapx8',I:{lTag:'$',name:'A.creBal(E_menIgual)'}},
	],wrap);
};
_Fi['cypRoute']=function(wrap){
	$Doc.filter({func:JCyp.Route.get},[
  {L:'Nombre',wxn:'wrapx4',I:{lTag:'input',name:'A.routeName(E_like3)'}},
  {L:'Sede',wxn:'wrapx4',I:{lTag:'select',name:'A.sucSede',opts:$Tb.cypSede}},
  {L:'Descripción',wxn:'wrapx4',I:{lTag:'input',name:'A.description(E_like3)'}},
	],wrap);
};
_Fi['cypSede.history']=function(wrap){
  Pa=$M.read();
	$Doc.filter({func:JCyp.Sede.history},[
  {k:'d1'},{k:'d2'},{k:'docStatus'},{k:'card'},{k:'ordBy'},
  {divLine:1,L:'Sede',wxn:'wrapx8',I:{lTag:'select',name:'A.sucSede',opts:$Tb.cypSede,value:Pa.vid}},
  {L:'Cobrador',wxn:'wrapx8',I:{lTag:'select',name:'A.slpId',opts:$Tb.oslp}},
  {L:'Ruta',wxn:'wrapx8',I:{lTag:'select',name:'A.logRoute',opts:$Tb.cypRoute}},
	],wrap);
};
_Fi['cypRep.quotes']=function(wrap){
	$Doc.filter({func:JCyp.Rep.quotes},[
  {L:'Reporte',wxn:'wrapx8',I:{lTag:'select',name:'_view',opts:[{k:'G',v:'Pendientes'},{k:'D',v:'Vencidas'}],noBlank:'Y'}},
  {k:'d1'},{k:'d2'},{k:'card'},
  {divLine:1,L:'Cobrador',wxn:'wrapx8',I:{lTag:'select',name:'A.slpId',opts:$Tb.oslp}},
  {L:'Ruta',wxn:'wrapx8',I:{lTag:'select',name:'A.logRoute',opts:$Tb.cypRoute}},
  {L:'Sede',wxn:'wrapx8',I:{lTag:'select',name:'A.sucSede',opts:$Tb.cypSede}},
...
_Fi['cypRep.contratos']=function(wrap){
  opts=[{k:'O',v:'Abiertos'},{k:'G',v:'General'}];
	$Doc.filter({func:JCyp.Rep.contratos},[
  {L:'Reporte',wxn:'wrapx8',I:{lTag:'select',name:'_view',opts:opts,noBlank:'Y'}},
  {k:'d1'},{k:'d2'},{k:'card'},
  {L:'Cobrador',wxn:'wrapx8',I:{lTag:'select',name:'A.slpId',opts:$Tb.oslp}},
  {L:'Ruta',wxn:'wrapx8',I:{lTag:'select',name:'A.logRoute',opts:$Tb.cypRoute}},
  {L:'Sede',wxn:'wrapx8',I:{lTag:'select',name:'A.sucSede',opts:$Tb.cypSede}},
  {divLine:1,L:'Frecuencia',wxn:'wrapx8',I:{lTag:'select',name:'A.cuoUdm',opts:$V.jcypFrec}},
  {L:'Cuotas',wxn:'wrapx8',I:{lTag:'input',name:'A.cuoNum(E_rang)',placeholder:'1-5 de (1 a 5)'}},
  {L:'Prestado >=',wxn:'wrapx8',I:{lTag:'$',name:'A.vPre(E_mayIgual)'}},
  {L:'Prestado <=',wxn:'wrapx8',I:{lTag:'$',name:'A.vPre(E_memIgual)'}},
  {L:'Pendiente >',wxn:'wrapx8',I:{lTag:'$',value:'0',name:'A.balDue(E_may)'}},
  {L:'Pendiente <=',wxn:'wrapx8',I:{lTag:'$',name:'A.balDue(E_menIgual)'}},
	],wrap);
};
_Fi['cypRep.rcv']=function(wrap){
  opts=[{k:'C',v:'Consolidado'},{k:'S',v:'Cobrador'},{k:'CC',v:'Cliente'},{k:'G',v:'General'}];
	$Doc.filter({func:JCyp.Rep.rcv},[
  {L:'Reporte',wxn:'wrapx8',I:{lTag:'select',name:'_view',opts:opts,noBlank:'Y'}},
  {k:'d1'},{k:'d2'},{k:'card'},
  {L:'Cobrador',wxn:'wrapx8',I:{lTag:'select',name:'A.slpId',opts:$Tb.oslp}},
  {L:'Ruta',wxn:'wrapx8',I:{lTag:'select',name:'A.logRoute',opts:$Tb.cypRoute}},
...
JCyp.Con={
  OLg:function(L){
		...
		ab.add('N',{addText:'Se anulará el Prestamo, no se puede modificar está acción.'});
  ...
  get:function(){
    ...
    {H:'Ruta',k:'logRoute',_g:$Tb.cypRoute},
  ...
  form:function(){
    ...
    $Api.get({f:Api.Cyp.pr+'con/form',loadVerif:!Pa.docEntry,inputs:'docEntry='+Pa.docEntry,loade:cont,func:function(Jr){
      ...
      $Api.form2({api:Api.Cyp.pr+'con',jsF:'Y',AJs:{L:[]},PUTid:Pa.docEntry,JrD:D,vidn:'docEntry',to:'cypCon.view',midTag:'Y',
        ...
        {wxn:'wrapx8',L:'Ruta',I:{lTag:'select',name:'logRoute',opts:$Tb.cypRoute,'class':$Api.Sea.clsBox,k:'logRoute',value:D.logRoute}},
        ...
        reqFields:{
          D:[{k:'cardId',iMsg:'Tercero'},{k:'docDate',iMsg:'Fecha Apertura'},{k:'vPre',iMsg:'Valor del Prestamo'}]
        },
      },cont);
  ...
  view:function(){
    ...
    $Api.get({f:Api.Cyp.pr+'con/view',inputs:'docEntry='+$M.Pa.docEntry,loade:cont,errWrap:cont,func:function(Jr){
      ...
      THs:[
        {docEntry:'Y'},{sdocTitle:'Y',cs:5,ln:1},{t:'Ruta',k:'logRoute',_g:$Tb.cypRoute,ln:1,cs:2},
        {t:'Tipo',k:'docType',_g:$V.jcypType},{middleInfo:'Y'},{logo:'Y'},
      ...
      Tabs:[
        ...
        {textNode:'Recargos',winClass:'pays','class':'fa fa-money',func:function(T){
          JCyp.Rec.get(T.win,{inputs:'A.otr='+$M.Pa.docEntry});
        }},
      ...
      $Doc.view(cont,tP);
      if(Jr.L){
        var tb=$1.T.table(['#','Vencimiento','$ Pendiente','','Cuota','Recargos','','a Interes','a Capital','','Saldo Capital','Saldo Deuda','']);
        ...
        if(Jr.L && !Jr.L.errNo){ for(var i2 in Jr.L){ L=Jr.L[i2];
          ...
          $1.t('span',{textNode:$Str.money(L.balRec)},td);
          JCyp.Fx.btnRec(L,td); 
          $1.t('td',{style:'backgroundColor:#EEE; width:20px'},tr);
...
JCyp.CR={
  ...
  cDefine:function(cont,P){
    ...
    R={
    'docType':P.docType,docDate:P.docDate,
    'vPre':P.vPre,'iTasa':iTTotal,
    'cuoNum':P.cuoNum,'cuoV':cuoV,
    'vFut':vFut,'iTTotal':iTTotal,
    'cuoPerCap':cuoPerCap,'cuoPerInt':cuoPerInt,
    };
    eiTasa=$1.q('[name="iTasa"]',cont);
    eiTasa.setAttribute('disabled','disabled');
    eiTasa.value=iTTotal*1;
    $1.tagSet('[name="cuoV"]',(tt)=>{
      tt.removeAttribute('disabled');
    },cont);
    return R;
...
JCyp.Crd={
  ...
  form:function(){
    ...
    tbH:[
      ...
      {wxn:'wrapx8',L:'Ruta',aGo:'jsv.cypRoute',I:{lTag:'select',name:'logRoute',opts:$Tb.cypRoute,value:D.logRoute}},
...
JCyp.Rcv={
  OLg:function(L){
		...
		ab.add('N',{addText:'Se anulará el pago, todos los Prestamos relacionados a el también serán afectados. No se puede modificar está acción.'});
  ...
  form:function(){
    ...
    var card=$1.lTag({tag:'card','class':'_crd',cardType:'C',fie:'slpId,logRoute',func:reLoa,fReset:reLoa,boxRep:'Y',topPare:cont});
    $Api.form2({api:Api.Cyp.pr+'rcv',AJs:D.AJs,JrD:D,uid:{k:'docEntry'},to:'cypRcv.view',jsF:'Y',midTag:'Y',
      tbH:[
      {divLine:1,L:'Fecha',req:'Y',wxn:'wrapx8',I:{lTag:'date',name:'docDate',value:D.docDate}},
      {L:'Cliente',req:'Y',wxn:'wrapx2',Inode:card},
      {wxn:'wrapx8',L:'Cobrador',req:'Y',I:{lTag:'select',name:'slpId',opts:$Tb.oslp,'class':$Api.Sea.clsBox,k:'slpId'}},
      {wxn:'wrapx8',L:'Ruta',req:'Y',I:{lTag:'select',name:'logRoute',opts:$Tb.cypRoute,'class':$Api.Sea.clsBox,k:'logRoute'}},
      ...
      reqFields:{
        D:[{k:'docDate',iMsg:'Fecha'},{k:'cardId',iMsg:'Cliente'},{k:'slpId',iMsg:'Cobrador'},{k:'logRoute',iMsg:'Ruta'},
        ],
  ...
  view:function(){
    ...
    $Api.get({f:Api.Cyp.pr+'rcv/view',inputs:'docEntry='+Pa.docEntry,loade:cont,errWrap:cont,func:function(Jr){
      ...
      $Doc.view(cont,tP);
      if(Jr.L){
        var tb=$1.T.table(['Prestamo','# Cuota','$ Pagado','','$ Pendiente','Vencia','$ Cuota','Recargos','']);
        tb.classList.add('table_x100');
  ...
  getCon:function(Px,midCont){
    $Api.get({f:Api.Cyp.pr+'con/topay',inputs:'cardId='+Px.cardId,loade:midCont,func:function(Jr){
      ...
      { 
        ...
        $1.T.fieset({L:{textNode:'Prestamos Abiertos'}},midCont,tb);
        ...
        $Api.foreach(Jr.L,function(L){
          ...
          if(lastdEntry!=L.docEntry){
            tr=$1.t('tr',0,tBody);
            $1.t('td',{textNode:'Prestamo # '+L.docEntry,colspan:4,style:'fontWeight:bold; backgroundColor:#DDD;'},tr);
...
JCyp.Rec={
  ...
  get:function(cont,P){
    ...
    {H:'Fecha',k:'docDate',dateText:'mmm d'},
    {H:'Prestamo',k:'otr'},
    {H:'No. Cuota',k:'lineNum'},
    {H:'Valor',k:'docTotal',format:'$'},
    {H:'Categoria',k:'docClass',_g:$JsV.cypRecClass},
    {H:'Cliente',k:'cardName'},
    {H:'Detalles',k:'lineMemo'},
    ];
    inputs=(P.inputs)?P.inputs+$1.G.filter():$1.G.filter();
    $Doc.tbList({api:Api.Cyp.pr+'rec',justOne:P.justOne,inputs:inputs,
    tbSerie:'cypRec',view:'N',main:JCyp.Rec.OLg,docBy:'userDate',TD:Cols},cont);
  },
  form:function(Pa){
    D={};
    if(!D.docDate){ D.docDate=$2d.today; }
    $Api.form2({api:Api.Cyp.pr+'rec',JrD:D,jsF:'Y',uid:{k:'N'},clearForm:'Y',
      Win:{winSize:'medium',winTitle:'Registro de Recargo'},
      tbH:[
      {L:'No. Prestamo',req:'Y',wxn:'wrapx4',I:{lTag:'number',name:'otr',value:Pa.docEntry}},
      {L:'No. Cuota',req:'Y',wxn:'wrapx4',I:{lTag:'number',name:'lineNum',value:Pa.lineNum}},
      {L:'Fecha',req:'Y',wxn:'wrapx4',I:{lTag:'date',name:'docDate',value:Pa.lineDue}},
      {wxn:'wrapx4',L:'Categoria',req:'Y',I:{lTag:'select',name:'docClass',opts:$JsV.cypRecClass}},
      {wxn:'wrapx4',L:'Valor Recargo',req:'Y',I:{lTag:'$',name:'docTotal'}},,
      {L:'Detalles',wxn:'wrapx4_1',I:{lTag:'textarea',name:'lineMemo',value:D.lineMemo}},
      ],
      reqFields:{
        D:[{k:'lineNum',iMsg:'No. Cuota'},{k:'docDate',iMsg:'Fecha'},{k:'docClass',iMsg:'Categoria'},{k:'docTotal',iMsg:'Valor Recargo'}
        ]
      }
    });
  },
...
JCyp.Rds={
  ...
  form:function(Pa){
    Pa=(Pa)?Pa:{}; var D={};
    if(!D.docDate){ D.docDate=$2d.today; }
    $Api.form2({api:Api.Cyp.pr+'rds',AJs:D.AJs,JrD:D,uid:{k:'id',v:Pa.id},jsF:'Y',
    Win:{winSize:'medium',winTitle:'Retiro de Socio'},clearForm:'Y',func:JCyp.Rds.get,
      tbH:[
      {L:'Fecha',req:'Y',wxn:'wrapx4',I:{lTag:'date',name:'docDate',value:D.docDate}},
      {L:'Socio',req:'Y',wxn:'wrapx4',I:{lTag:'card',_D:'Y','class':'_crd',cardType:'A',fie:'sucSede'}},
      {L:'Sede',req:'Y',wxn:'wrapx4',I:{lTag:'select',name:'sucSede',opts:$Tb.cypSede}},
      ...
      reqFields:{
        D:[{k:'docDate',iMsg:'Fecha'},{k:'cardId',iMsg:'Socio'},{k:'sucSede',iMsg:'Sede'},{k:'creBal',iMsg:'Monto del retiro'}
        ]
      }
    });
  },
...
JCyp.Egr={
  OLg:function(L){
		var Li=[];
    L.docEntry=L.id;
		var ab=new $Doc.liBtn(Li,L,{api:Api.Cyp.pr+'egr',tbSerie:'cypEgr'});
		ab.add('L');
		ab.add('N',{addText:'Se anulará el gasto. No se puede reversar está acción.'});
		return $Opts.add('cypEgr',Li,L);
	},
  get:function(){
    var cont=$M.Ht.cont;
    var Cols=[
    ...
    {H:'Fecha',k:'docDate',dateText:$V.cypDateForm},
    {H:'Valor',k:'creBal',format:'$'},
    {H:'Categorias',k:'categId',_g:$JsV.cypEgrClass},
    {H:'Cobrador',k:'slpId',_g:$Tb.oslp},
    {H:'Ruta',k:'logRoute',_g:$Tb.cypRoute},
    {H:'Sede',k:'sucSede',_g:$Tb.cypSede},
    {H:'Tercero',k:'cardName'},
    ...
    $Doc.tbList({api:Api.Cyp.pr+'egr',inputs:$1.G.filter(),
    tbSerie:'cypEgr', _fEdit:JCyp.Egr.form,view:'N',main:JCyp.Egr.OLg,docBy:'userDate',TD:Cols},cont);
  },
  form:function(Pa){
    Pa=(Pa)?Pa:{}; var D={};
    if(!D.docDate){ D.docDate=$2d.today; }
    $Api.form2({api:Api.Cyp.pr+'egr',AJs:D.AJs,JrD:D,uid:{k:'id',v:Pa.id},jsF:'Y',
    Win:{winSize:'medium',winTitle:'Registro de Gasto'},clearForm:'Y',func:JCyp.Rds.get,
      tbH:[
      {L:'Fecha',req:'Y',wxn:'wrapx4',I:{lTag:'date',name:'docDate',value:D.docDate}},
      {L:'Sede',req:'Y',wxn:'wrapx4',I:{lTag:'select',name:'sucSede',opts:$Tb.cypSede}},
      {L:'Monto',req:'Y',wxn:'wrapx4',I:{lTag:'$',name:'creBal'}},
      {L:'Categoria',req:'Y',wxn:'wrapx4',I:{lTag:'select',name:'categId',opts:$JsV.cypEgrClass}},
      {divLine:1,L:'Socio',wxn:'wrapx2',I:{lTag:'card',_D:'Y','class':'_crd',cardType:'A',fie:'sucSede'}},
      
      {L:'Ruta',wxn:'wrapx4',I:{lTag:'select',name:'logRoute',opts:$Tb.cypRoute}},
      {L:'Cobrador',wxn:'wrapx4',I:{lTag:'select',name:'slpId',opts:$Tb.oslp}},
      {divLine:1,L:'Detalles',wxn:'wrapx1',I:{lTag:'textarea',name:'lineMemo',value:D.lineMemo}},
      {addIf:(L,P)=>{  if(L.id>0){ return 'Y'; } return 'N'; },divLine:1,L:'Motivo modificación',wxn:'wrapx1',I:{lTag:'textarea',name:'lineMemoUpd',value:D.lineMemoUpd}},
      ],
      reqFields:{
        D:[{k:'docDate',iMsg:'Fecha'},{k:'sucSede',iMsg:'Sede'},{k:'creBal',iMsg:'Monto del retiro'}
        ]
      }
    });
  },
...
JCyp.Rep={
  contratos:function(){
    var cont=$M.Ht.cont;
    inputs=$1.G.filter();
    $Api.Rep.base({f:Api.Cyp.pr+'rep/contratos',inputs:inputs,
		V_G:[
    {t:'Cliente',k:'cardName'},
    {t:'Prestamo',k:'docEntry'},
    {t:'Solicitado',k:'vPre',fType:'$',totals:'Y'},
    {t:'Interes',k:'intTotal',fType:'$',totals:'Y'},
    {t:'Recargos',k:'recTotal',fType:'$',totals:'Y'},
    {t:'Total',k:'docTotal',fType:'$',totals:'Y'},
    {t:'Pendiente',k:'balDue',fType:'$',totals:'Y'},
    {t:'Cuotas',k:'cuoNum'},
    {t:'$ Cuota',k:'cuoV',fType:'$'},
    {t:'Frecuencia',k:'cuoUdm',_g:$V.jcypFrec},
    {t:'Cobrador',k:'slpId',_g:$Tb.oslp},
    {t:'Ruta',k:'logRoute',_g:$Tb.cypRoute},
    {t:'Sede',k:'sucSede',_g:$Tb.cypSede},
    ]},cont);
  },
  quotes:function(){
    var cont=$M.Ht.cont;
    inputs='B.balDue(E_may)=0&'+$1.G.filter()
    $Api.Rep.base({f:Api.Cyp.pr+'rep/quotes',inputs:inputs,
		V_G:[
    {t:'Vencimiento',k:'lineDue'},
    {t:'# Cuota',k:'lineNum'},
    {t:'Pendiente',k:'balDue',fType:'$'},
    {t:'$ Cuota',k:'cuoV',fType:'$'},
    {t:'Prestamo',k:'docEntry'},
    {t:'Cliente',k:'cardName'},
    {t:'Cobrador',k:'slpId',_g:$Tb.oslp},
    ...
    V_D:[
    {func:(L,td)=>{ JCyp.Fx.btnRec(L,td); }},
    {t:'Vencimiento',k:'lineDue'},
    {t:'Dias Atraso',k:'lineDue',fText:(L)=>{
      return $2d.diff({date1:L.lineDue,g:'days'});
    }},
    {t:'# Cuota',k:'lineNum'},
    {t:'Pendiente',k:'balDue',fType:'$'},
    {t:'$ Cuota',k:'cuoV',fType:'$'},
  ...
  rcv:function(){
    var cont=$M.Ht.cont;
    inputs=$1.G.filter();
    $Api.Rep.base({f:Api.Cyp.pr+'rep/rcv',inputs:inputs,
		V_C:[
    {t:'Sede',k:'sucSede',_g:$Tb.cypSede},
    {t:'Cobrador',k:'slpId',_g:$Tb.oslp},
    {t:'Ruta',k:'logRoute',_g:$Tb.cypRoute},
    {t:'Cobrado',k:'docTotal',fType:'$',totals:'Y'},
    ],
    V_S:[
      {t:'Cobrador',k:'slpId',_g:$Tb.oslp},
      {t:'Cobrado',k:'docTotal',fType:'$',totals:'Y'},
    ...
    V_G:[
      {t:'No. Prestamo',k:'otr'},
      {t:'No. Cuota',k:'lineNum'},
      {t:'Cliente',k:'cardName'},
      {t:'Cobrado',k:'bal',fType:'$',totals:'Y'},
      {t:'Sede',k:'sucSede',_g:$Tb.cypSede},
      {t:'Cobrador',k:'slpId',_g:$Tb.oslp},
      {t:'Ruta',k:'logRoute',_g:$Tb.cypRoute},
      {t:'Vencia',k:'lineDue'},
      {t:'Pagada',k:'docDate'},
      {t:'Atraso',k:'docDate',fText:(L)=>{ return $2d.diff({docDate:L.lineDue,dueDate:L.docDate,g:'days'}); }},
      ],
  },cont);
  },
...
JCyp.Sede={
  ...
  history:function(){
    ...
    var Cols=[
      ...
      {H:'Fecha',k:'docDate'},
      {H:'Tercero',k:'cardName'},
      {H:'Cobrador',k:'slpId',_g:$Tb.slpId},
      {H:'Ruta',k:'logRoute',_g:$Tb.cypRoute},
      {H:'Sede',k:'sucSede',_g:$Tb.cypSede},
      {H:'Origen',k:'tt'},
    ];
...
JCyp.Route={
  get:function(){
    var cont=$M.Ht.cont;
    var Cols=[
      {H:'Nombre',k:'routeName'},
      {H:'Sede',k:'sucSede',_g:$Tb.cypSede},
      {H:'Descripción',k:'description'},
    ];
    $Doc.tbList({api:Api.Cyp.pr+'route',inputs:$1.G.filter(),tbSerie:'N',
    _fEdit:JCyp.Route.form,view:'N',tbSerie:'cypRoute',fOpts:JCyp.Route.opts,
    TD:Cols,
    },cont);
  },
  form:function(Pa){ Pa=(Pa)?Pa:{};
    var cont=$M.Ht.cont;
    $Api.form2({api:Api.Cyp.pr+'route',uid:{k:'vid',v:Pa.vid},jsF:'Y',clearForm:'N',
    Win:{winTitle:'Ruta',winSize:'medium'},
    func:function(Jr2,o){ $Sysd.TbUpd('cypRoute',o); JCyp.Route.get(); },
      tbH:[
      {L:'Nombre',wxn:'wrapx4',req:'Y',I:{lTag:'input',name:'routeName'}},
      {L:'Sede',wxn:'wrapx4',req:'Y',I:{lTag:'select',name:'sucSede',opts:$Tb.cypSede}},
      {divLine:1,L:'Descripción',wxn:'wrapx1',I:{lTag:'input',name:'description'}},
      ],
    },cont);
  },
}
...
JCyp.Fx={
  ...
  btnRec:(L,pare)=>{
    return $1.T.btnFa({fa:'fa-exclamation-triangle',title:'Registrar Recargo',P:L,func:(T)=>{ JCyp.Rec.form(T.P); }},pare);
  }
}
...
$M.liAdd('cyp',[
  ...
  {k:'cypRds',t:'Retiros Socios',ini:{f:'cypRds',fNew:JCyp.Rds.form,gyp:JCyp.Rds.get}},

  {k:'cypEgr',t:'Gastos',ini:{f:'cypEgr',fNew:JCyp.Egr.form,gyp:JCyp.Egr.get}},
  {k:'cypRcv',t:'Cobros',ini:{btnGo:'cypRcv.form',f:'cypRcv',gyp:JCyp.Rcv.get}},
  {k:'cypRcv.form',t:'Pago',ini:{g:JCyp.Rcv.form}},
  {k:'cypRcv.view',t:'Pago',noTitle:'Y',ini:{g:JCyp.Rcv.view}},

  {k:'cypRec',t:'Recargos',ini:{f:'cypRec',g:JCyp.Rec.get}},
  

  /*cnf*/
  {k:'cypRoute',t:'Rutas',ini:{f:'cypRoute',btnGo:'cypRoute.form',gyp:JCyp.Route.get}},
  {k:'cypRoute.form',t:'Ruta',ini:{g:JCyp.Route.form}},
  {k:'cypSede',t:'Sedes',ini:{btnGo:'bt.cypSede.form',gyp:JCyp.Sede.get}},
  {k:'cypSede.form',t:'Sede',ini:{g:JCyp.Sede.form}},
  {k:'cypSede.history',t:'Historial Movimiento Dinero',ini:{f:'cypSede.history',g:JCyp.Sede.history}},

  {k:'cypRep.contratos',t:'Reporte de Prestamos',ini:{f:'cypRep.contratos'}},
  {k:'cypRep.quotes',t:'Reporte Cuotas',ini:{f:'cypRep.quotes'}},
  {k:'cypRep.rcv',t:'Reporte Cobros',ini:{f:'cypRep.rcv'}},
],{prp:{mdlActive:'cyp'}});

$JsV.liAdd([
  {kMdl:'cyp',kObj:'cypRecClass',mdl:'a1',liTxtG:'Concepto Recargos',liTxtF:'Concepto Recargo'},
  {kMdl:'cyp',kObj:'cypEgrClass',mdl:'a1',liTxtG:'Concepto Gastos',liTxtF:'Concepto Gastos'},
],{});

$M.kLiTable['cyp']={mdlActive:'cyp',MLis:['cypCon','cypRcv','cypCrd'],_F:[
	{doc:['cypCon','cypRcv','cypEgr','cypAps','cypRds']},
  {folId:'cuo',folName:'Cuotas',MLis:['cypRep.quotes','cypRec']},
	{rep:['cypRep.contratos','cypSede.history','cypRep.quotes','cypRep.rcv']},
  {mas:['cypRoute','cypCso','cypSede','tb.oslp','jsv.cypEgrClass','jsv.cypRecClass']},
]};