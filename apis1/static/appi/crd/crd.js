...
{textNode:'Propiedades',winClass:'_wincrdprp'}
];
...
form:function(P,cont){
	...
	if(!winAddr){ delete($Mdl.Cnf.crdFichaPut[1]); }
...
$Tb._i({kMdl:'crd',kObj:'oslp',kau:'sysd.suadmin',liTxtG:'Responsables',liTxtF:'Responsable ',Cols:[
