...
$M.liRep('ivt',[
	...
	],{repM:['ivt'],prp:{mdlActive:'ivt'}});

$M.liAdd('ivt',[{_lineText:'_TB'}]);
$Tb._i({kObj:'itmOwhs',
kMdl:'ivt',liTxtG:'Almacenes',mdlActive:'ivtMWhs',liTxtF:'Almacen',
Cols:[
...
$JsV._i({kMdl:'ivt',kObj:'ivtDocClass',mdl:'itm',liTxtG:'Clase - Documentos',liTxtF:'Clase Documento'});
